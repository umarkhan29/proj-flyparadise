...
<body>
  ...
  <div id="mobile-menu--wrapper" class="privacy">
    ...
    <div id="main">
      <div class="title-rev">
        <h2 class="seven-h">Privacy Policy</h2>
      </div>
      <div class="policy seven-h">
        <p>This page informs you of our Company (Fly Paradise Travels Pvt Ltd) policies regarding the collection, use and disclosure
          of Personal Information we receive from users of the Site and the Fly Paradise software. We use your Personal Information
          only to enable us to improve our service, our software, and to improve the Site. By using the Site, you agree to
          the collection and use of information in accordance with this policy.
          <br>
          <br> This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable
          ...
          use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</p>
        <br>
        <br>
        <div class="accordion darkborder bg-blue">
          <strong>What personal information do we collect from the people that visit our website?</strong>
          <div class="accordion-opening remove">
            <p>
              When booking package or registering on Fly Paradise, as appropriate, you may be asked to enter your name, email address,
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>We collect information from you when you subscribe to a newsletter, fill out a form, Use Live Chat, Open a Support
              Ticket or enter information on our site (Fly Paradise).
            </p>
          </div>
        </div>
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>We may use the information we collect from you when you register, book (make a purchase), sign up for our newsletter,
        ...
        <div class="accordion darkborder bg-blue">
          <strong>ow do we protect your information?</strong>
          <div class="accordion-opening remove">
            <p>Our website is scanned on a regular basis for security holes and known vulnerabilities in order to make your
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>
              ...
              browser (if you allow) that enables the site's or service provider's systems to recognize your browser and
              ...
              current site activity, which enables us to provide you with improved services. We also use cookies to help
              us compile aggregate data about site traffic and site interaction so that we can offer better site experiences
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            ...
            <p>
              in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>
              ...
              users with advance notice. This does not include website hosting partners and other parties who assist us in
              operating our website, conducting our business, or serving our users, so long as those parties agree to keep
              ...
              <br> However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising,
              or other uses.
            </p>
          </div>
        </div>
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            ...
            <p>
              ...
              ads to our users based on previous visits to our site and other sites on the Internet. Users may opt-out of
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            ...
            <p>
              ...
              cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>
              ...
              out by visiting the Network Advertising Initiative Opt Out page or by using the Google Analytics Opt Out Browser
              add on.
            </p>
          </div>
        </div>
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>
              Users can visit our site anonymously. Once this privacy policy is created, we will add a link to it on our home page or as
            ...
            <ul>
              <li>By logging in to your account
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion darkborder bg-blue">
          <strong>Does our site allow third-party behavioural tracking?</strong>
          <div class="accordion-opening remove">
            <p>
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            ...
            <p> we do not let third-parties, including ad networks or plug-ins collect PII from children under 13?
            </p>
            </p>
          </div>
        </div>
        ...
        <div class="accordion darkborder bg-blue">
          <strong>In order to be in line with Fair Information Practices we will take the following responsive action, should a data
            breach occur:
          </strong>
          <div class="accordion-opening remove">
            <p>
            ...
            <p>
              ...
              rights against data collectors and processors who fail to adhere to the law. This principle requires not only
              that individuals have enforceable rights against data users, but also that individuals have recourse to courts
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            <p>
              ...
              <br> And we will promptly remove you from
        ...
        <div class="accordion darkborder bg-blue">
          ...
          <div class="accordion-opening remove">
            ...
            <p>https://flyparadise.in
              <br>5 Boulevard
              <br>Srinagar, J&amp;K 190001
              <br>India
              <br>support@flyparadise.in
              <br>18001232262</p>
          </div>
        </div>

        <p class="last-edited">Last Edited on 2018-02-22</p>
      </div>
    </div>
<?php
